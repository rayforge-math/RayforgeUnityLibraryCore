...
namespace Rayforge.Core.Environment.Spatial
{
        ...
        where TValue : ISpatialEntry
    {
        ...
        protected SpatialRegistry(Transform container = null, string defaultName = "SpatialRegistry_Container")
        {
            ...
            {
                _container = new GameObject(defaultName).transform;
        ...
        public virtual void RemoveAndDestroy(TKey key)
        {
            if (_storage.Remove(key, out TValue value))
            {
                ...
                {
                    if (Application.isPlaying) Object.Destroy(value.gameObject);
                    else Object.DestroyImmediate(value.gameObject);
                }
        ...
        private void TryCleanupContainer()
        {
            ...
            {
                if (Application.isPlaying) Object.Destroy(_container.gameObject);
                else Object.DestroyImmediate(_container.gameObject);
