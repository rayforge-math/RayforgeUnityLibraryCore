...
namespace Rayforge.Core.Collections.Buffered
{
        ...
        where TValue : unmanaged
    {
        ...
        public IIterator<BufferSegmentMeta> GetDirtyBatchIterator(bool mergeContiguous = true)
        {
            ...
            var logic = new DirtySegmentIteratorState(m_CpuData, m_DirtyBits, m_BatchSize, m_CpuData.Length, mergeContiguous);
            return new Iterator<BufferSegmentMeta, DirtySegmentIteratorState>(logic);
        }
