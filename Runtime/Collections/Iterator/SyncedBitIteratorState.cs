...
namespace Rayforge.Core.Collections.Iterator
{
    ...
    /// </para>
    /// </summary>
    public struct SyncedBitIteratorState : IIterationLogic<SyncedBitIteratorMeta, SyncedBitIteratorState>
    {
        ...
        /// </summary>
        public bool MoveNext(ref SyncedBitIteratorState self, out SyncedBitIteratorMeta result)
        {
            ...
            if (targetIndex < self._endIndex)
            {
                ...
                result = new SyncedBitIteratorMeta(targetIndex, hitA, hitB);
                return true;
            }
        ...
        /// </summary>
        public bool TryPeekNext(ref SyncedBitIteratorState self, out SyncedBitIteratorMeta result)
        {
            bool hasA = self._stateA.TryPeekNext(ref self._stateA, out int peekA);
            bool hasB = self._stateB.TryPeekNext(ref self._stateB, out int peekB);
            ...
            result = new SyncedBitIteratorMeta(targetIndex,
