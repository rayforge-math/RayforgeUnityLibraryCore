...
namespace Rayforge.Core.Collections.Abstractions.Tests
{
        ...
        where T : unmanaged
    {
        ...
        {
            var seg = new BufferSegmentMeta<T>();
        ...
        {
            var seg = new BufferSegmentMeta<T> { Start = 3, Count = 5 };
        ...
        {
            var seg = new BufferSegmentMeta<T> { Start = 0, Count = 4 };
        ...
        {
            var seg = new BufferSegmentMeta<T> { Start = 5, Count = 0 };
        ...
        {
            var seg = new BufferSegmentMeta<T> { Source = null, Count = 5 };
            Assert.IsTrue(seg.IsEmpty);
        }
        ...
        {
            var seg = new BufferSegmentMeta<T> { Source = new T[5], Count = 0 };
            Assert.IsTrue(seg.IsEmpty);
        }
        ...
        {
            var seg = new BufferSegmentMeta<T> { Source = new T[5], Count = -1 };
            Assert.IsTrue(seg.IsEmpty);
        }
        ...
        {
            var seg = new BufferSegmentMeta<T> { Source = new T[5], Start = 0, Count = 3 };
        ...
        {
            var seg = new BufferSegmentMeta<T> { Start = 3, Count = 0 };
        ...
        {
            var seg = new BufferSegmentMeta<T> { Start = 0, Count = 5 };
        ...
        {
            var seg = new BufferSegmentMeta<T> { Start = 4, Count = 1 };
